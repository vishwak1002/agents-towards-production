...
class MeetingAgent:
    ...
    Args:
        agent (Agent): The xpander.ai Meeting Recorder Agent
    """
    ...
    def __init__(
        ...
        # load agent instructions from file. you can change the instructions in the file to change the agent's behavior
